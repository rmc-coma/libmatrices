...
#    Updated: 2016/02/25 00:05:49 by rmc-coma         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC =	m_vec4ini.c m_vec4val.c m_vec4new.c m_vec4set.c m_vec4cpy.c m_vec4to3.c	\
		...
		m_vec3nrm.c	m_vec3crs.c	m_vec4add.c m_vec4sub.c							\
...
debug: $(NAME)
	$(CC) $(CFLAGS) -I $(HDR) -c $(SRC) m_mat4put.c m_vec4put.c m_vec3put.c main.c
	$(CC) $(CFLAGS) -o $(NAME) $(NAME).a $(OBJ) m_mat4put.o m_vec4put.o m_vec3put.o main.o